    ...
    constructor() {
        super({
            ...
            hint: {
                ...
                nl: 'Ondersteuning voor Ambient Weather F007TH, Ambient Weather F012TH, TFA zenders 30.3208.02, SwitchDoc Labs F016TH, OneConcept'
            }
        })
    }
...
module.exports = {
    ambient_weather: AmbientWeather // We need to export the id
};
